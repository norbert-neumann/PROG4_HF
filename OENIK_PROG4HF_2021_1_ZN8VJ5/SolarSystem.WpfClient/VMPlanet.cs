namespace SolarSystem.WpfClient
{
    ...
    public class VMPlanet : ObservableObject
    {
        ...
        public float Mass
        {
            ...
            set { this.Set(ref this.mass, value); }
        }
        ...
        public float Diameter
        {
            ...
            set { this.Set(ref this.diameter, value); }
        }
        ...
        {
            get { return this.molecules; }
            set { this.Set(ref this.molecules, value); }
        }
        ...
        /// List of all stars.
        /// </summary>
        public IList<Star> AllHosts { get; set; }
